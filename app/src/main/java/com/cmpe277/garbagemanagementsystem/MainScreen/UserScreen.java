...
//        toolbar.showOverflowMenu();
        ...
        Fragment fragment = new UserHomeFrag();
        FragmentTransaction ft = getSupportFragmentManager().beginTransaction();
        ft.add(R.id.user_home_content, fragment);
        ft.commit();
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        if (id == R.id.nav_about_us) {
            intent = new Intent(UserScreen.this, AboutUs.class);
        ...
        if (id == R.id.nav_log_out) {
            ...
            intent = new Intent(UserScreen.this, MainActivity.class);
            startActivity(intent);
        }
        if (id == R.id.nav_home) {
            fragment = new UserHomeFrag();
        }
        if (fragment != null) {
            FragmentTransaction ft = getSupportFragmentManager().beginTransaction();
            ft.replace(R.id.user_home_content, fragment);
            ft.commit();
        }
