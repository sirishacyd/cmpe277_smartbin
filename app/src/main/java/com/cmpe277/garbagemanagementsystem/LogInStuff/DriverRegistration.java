...
import com.baig.garbagemanagementsystem.databinding.ActivityDriverRegistrationBinding;
                ...
                mAuth.createUserWithEmailAndPassword(binding.emailAddress.getText().toString(),
                        ...
                        .addOnCompleteListener(this, task -> {
                            ...
                            if (task.isSuccessful()) {
                                ...
                                firebaseDatabase.getReference().child("Drivers").child(binding.userName
                                        .getText().toString()).setValue(drivers);
